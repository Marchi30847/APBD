...
public class UserServiceTest
{
    ...
    public void AddUser_InvalidUserInfo_ShouldReturnFalse(string firstName, string lastName, string email,
        string dateOfBirth)
    {
    ...
    public void AddUser_DifferentClientTypesAndCreditLimits_ShouldReturnExpectedResult(string clientType,
        bool hasCreditLimit, int creditLimit, bool expectedResult)
    {
        // Arrange
        var firstName = "FirstName";
        var lastName = "LastName";
